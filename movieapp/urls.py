...
urlpatterns = [
                ...
                path('profile/movie/edit/<slug:movie_id>/',views.MovieEditView.as_view(),name="movie_edit"),
                ...
                path('movie/<slug:movie_id>/',views.MovieView.as_view(),name='movie_view'),
                path('movie/<slug:movie_id>/rate/',views.rate_movie,name="rate"),
                path('profile/pending/',views.PendingView.as_view(),name='pending'),
                path('profile/<slug:movie_id>/review/',views.review_movie,name="review"),
                ...
                path('artist/<slug:artist_id>/',views.ArtistView.as_view(),name='artist_view'),
                path('profile/artist/delete/',views.artist_delete,name='artist_delete'),
                path('profile/artist/',views.user_artists,name="artist"),
                path('profile/artist/edit/<slug:artist_id>',views.ArtistEditView.as_view(),name="artist_edit"),
